...
<Playground>
  ...
  <Button label="Sign In" appearance="outlined" style={{ marginTop: 10 }} />
  <Button label="Sign In" appearance="text" style={{ marginTop: 10 }} />
</Playground>
...
<Playground>
  ...
  <Button label="Sign In" status="active" style={{ marginTop: 10 }} />
</Playground>
